...
export const createAppUserOpenUserEventUseCase = () => {
    return new AppUserOpenUserEventUseCase(appRepository);
};

export class AppUserOpenUserEventUseCase extends UseCase {
